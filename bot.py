...
def start(message):
    ...
    if user_id in allowed_users:
        ...
        bot.reply_to(message, 'welcome to the Spam Mail bot                                                       Dev : @kkkzkzz', reply_markup=keyboard)
    else:
        bot.reply_to(message, 'البوت مجاني يرجى إرسال أيديك هنا للتفعيل                                        - @kkkzkzz')
...
def show_admin_commands(message):
    if message.from_user.id == 7824599639:  # تم تعديل هذا السطر
